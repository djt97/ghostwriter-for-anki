...
Ghostwriter for Anki — a Chrome/Edge Manifest V3 extension (v0.4.0) for AI-assisted Anki flashcard creation. Integrates with AnkiConnect (add-on 2055492159) running in desktop Anki. Supports Google Gemini, OpenAI, and UltimateAI as LLM providers.
